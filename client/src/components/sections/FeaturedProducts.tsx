...
const FEATURED_PRODUCTS: ProductCardProps[] = [
  ...
  {
    id: 2, name: 'Tata Sampann Premium Pure Cow Ghee 1L', slug: 'tata-sampann-cow-ghee-1l',
    price: 649, original_price: 720, discount_percent: 10, weight: '1L',
    thumbnail: '/images/categories/oils-ghee.png', rating: 4.9, review_count: 231,
    is_featured: true, is_best_seller: true,
  ...
  {
    id: 3, name: 'Tata Tea Gold Premium Leaf Tea 1kg', slug: 'tata-tea-gold-1kg',
    price: 449, original_price: 520, discount_percent: 13, weight: '1kg',
    thumbnail: '/images/categories/tea-coffee-beverages.png', rating: 4.8, review_count: 312,
    is_featured: true, is_best_seller: true,
  ...
  {
    id: 4, name: 'Tata Sampann Premium Toor Dal (Arhar) 1kg', slug: 'tata-sampann-toor-dal-1kg',
    price: 189, original_price: 220, discount_percent: 14, weight: '1kg',
    thumbnail: '/images/categories/atta-rice-dal.png', rating: 4.8, review_count: 289,
    is_featured: true, is_best_seller: true,
  ...
  {
    id: 5, name: 'Tata Sampann Turmeric Powder (Haldi) 500g', slug: 'tata-sampann-turmeric-500g',
    price: 129, original_price: 160, discount_percent: 19, weight: '500g',
    thumbnail: '/images/categories/masala-spices-salt.png', rating: 4.8, review_count: 222,
    is_featured: true, is_best_seller: true,
  ...
  {
    id: 6, name: 'Tata Soulfull Fruit & Nut Millet Muesli 400g', slug: 'tata-soulfull-muesli-400g',
    price: 249, original_price: 299, discount_percent: 16, weight: '400g',
    thumbnail: '/images/categories/breakfast-essentials.png', rating: 4.8, review_count: 134,
    is_featured: true, is_best_seller: true,
  ...
  {
    id: 7, name: 'Tata Sampann Yumside Paneer Butter Masala 300g', slug: 'tata-sampann-paneer-butter-masala-300g',
    price: 129, original_price: 149, discount_percent: 13, weight: '300g',
    thumbnail: '/images/categories/sauces-instant-foods.png', rating: 4.7, review_count: 112,
  ...
  {
    id: 8, name: 'Whole Cashews W240 Grade', slug: 'whole-cashews-w240',
