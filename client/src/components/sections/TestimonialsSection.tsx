...
const testimonials = [
  {
    ...
    review: 'NutriRoots has completely transformed my snacking habits! The quality of their almonds and cashews is simply unmatched. I can taste the freshness in every single bite. I\'ve been recommending them to all my clients and they all love it!',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/images/testimonials/customer-1.png',
    review: 'As a fitness enthusiast who is very particular about nutrition quality, NutriRoots consistently delivers the absolute best. The Kashmiri walnuts are absolutely premium - you can see and taste the difference from day one. Outstanding quality!',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/images/testimonials/customer-1.png',
    review: 'The Medjool dates from NutriRoots are absolutely divine! So plump, naturally sweet, and incredibly fresh. I\'ve been ordering for 6 months and the quality never ever disappoints. Perfect for my whole family, from kids to grandparents!',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/images/testimonials/customer-1.png',
    review: 'As a nutritionist, I recommend NutriRoots to all my patients. Their products are genuinely natural, chemical-free, and of hospital-grade quality. The lab reports they share are transparent and trustworthy. Simply the best!',
    rating: 5,
  ...
  },
  {
    ...
    avatar: '/images/testimonials/customer-1.png',
    review: 'I ordered the gift hamper for Diwali and my entire family was blown away by the packaging and quality. NutriRoots made me look like a thoughtful gift-giver! The pistachios were particularly extraordinary. Will definitely order again.',
    rating: 5,
...
export default function TestimonialsSection() {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(135deg, #6B3E26 0%, #3D1F0E 100%)' }}
    >
      <div className="container-luxury">
        ...
        <div ref={sliderRef} className="max-w-4xl mx-auto mb-10 testimonial-card">
          <div className="relative p-8 md:p-12 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20">
            ...
            <div className="flex gap-1 mb-6">
              {[...Array(active.rating)].map((_, i) => (
                <Star key={i} size={20} className="fill-accent-DEFAULT text-accent-DEFAULT" />
              ))}
            </div>
