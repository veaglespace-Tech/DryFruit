...
const navLinks = [
  ...
  { label: 'About', href: '/about' },
  {
    ...
    submenu: [
      ...
      { label: 'Raisins', href: '/products?category=raisins' },
      { label: 'Figs (Anjeer)', href: '/products?category=figs' },
      { label: 'Healthy Seeds', href: '/products?category=seeds' },
      { label: 'Mixed Nuts & Mixes', href: '/products?category=mixed-nuts' },
    ],
  },
