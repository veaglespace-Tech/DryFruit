...
import { Leaf, Phone, MessageCircle, Mail, MapPin, Share2, Globe, Link as LinkIcon, ArrowRight, Heart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              {[
                { icon: Share2, href: 'https://instagram.com/nutriroots', label: 'Instagram' },
                { icon: Globe, href: 'https://facebook.com/nutriroots', label: 'Facebook' },
                { icon: LinkIcon, href: 'https://twitter.com/nutriroots', label: 'Twitter' },
                { icon: MessageCircle, href: 'https://youtube.com/nutriroots', label: 'YouTube' },
          ...
          {/* Categories */}
          <div>
            <h3 className="font-heading text-lg font-semibold text-white mb-6">Categories</h3>
            <ul className="space-y-3">
              {categories.map((cat) => (
                <li key={cat.label}>
                  <Link
