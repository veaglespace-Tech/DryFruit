...
import { Settings, Save, Leaf, ShieldAlert } from 'lucide-react';
...
export default function AdminSettingsPage() {
  ...
  const [address, setAddress] = useState('123, Green Valley Road, Pune, Maharashtra 411001');
  const [announcementText, setAnnouncementText] = useState('🌿 Free delivery on orders above ₹999 | ✨ 100% Natural & Chemical Free');
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white border border-border-DEFAULT rounded-2xl p-6 md:p-8 shadow-card space-y-6">
      <div className="flex items-center gap-3 border-b border-border-light pb-4">
        ...
        <div>
          <h1 className="font-heading text-xl font-bold text-primary-DEFAULT">Site Settings</h1>
          <p className="text-xs text-text-muted font-body">Manage global metadata and information</p>
        </div>
      </div>
