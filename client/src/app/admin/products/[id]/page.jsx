    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link
            href="/admin/products"
            className="w-9 h-9 border border-border-DEFAULT hover:bg-background flex items-center justify-center rounded-xl text-text-muted transition-colors"
          >
            <ArrowLeft size={16} />
          </Link>
          <div>
      ...
      <form onSubmit={handleSubmit} className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-border-DEFAULT rounded-2xl p-6 shadow-card space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {benefits.map((b, index) => (
                <span
                  key={index}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-50 text-xs font-body font-semibold text-primary-DEFAULT rounded-xl"
                >
                  {b}
                  <button
                    type="button"
        ...
        <div className="md:col-span-1 space-y-6">
          ...
          <div className="bg-white border border-border-DEFAULT rounded-2xl p-5 shadow-card space-y-4">
            <h3 className="font-heading text-sm font-semibold text-primary-DEFAULT border-b border-border-light pb-2">
              Product Image
            </h3>
            <div className="border-2 border-dashed border-border-DEFAULT rounded-xl p-4 text-center cursor-pointer hover:bg-background transition-colors relative">
              ...
              <p className="text-xs text-text-muted font-body">
                {file ? `Selected: ${file.name}` : "Change product image"}
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-border-DEFAULT rounded-2xl p-5 shadow-card space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary-luxury justify-center py-3 text-xs"
            >
              <Save size={14} />
