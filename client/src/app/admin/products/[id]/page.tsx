    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading text-2xl font-bold text-primary-DEFAULT">Edit Product</h1>
            <p className="text-xs text-text-muted font-body">Modify catalog properties</p>
          </div>
        </div>
      </div>
