  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      >
        {/* Logo */}
        <div
          className={`flex items-center gap-3 p-4 border-b border-white/10 ${sidebarOpen ? "" : "justify-center"}`}
        >
          ...
          {sidebarOpen && (
            <div className="flex flex-col">
              ...
              <p className="font-body text-[9px] font-bold uppercase tracking-widest text-[#D4A95A] mt-1">
                Enterprises
              </p>
            </div>
          )}
      ...
      {/* Main Content */}
      <div
        className={`flex-1 flex flex-col transition-all duration-300 ${sidebarOpen ? "lg:pl-64" : "lg:pl-16"}`}
      >
        {/* Top Bar */}
        <header className="sticky top-0 z-30 flex items-center justify-between h-16 px-6 bg-white border-b border-border-DEFAULT shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-button font-semibold text-text-DEFAULT text-sm">
                {adminNavLinks.find((l) => pathname.startsWith(l.href))
                  ?.label || "Dashboard"}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/"
              className="text-xs font-button text-text-muted hover:text-primary-DEFAULT transition-colors"
            >
              View Site
            </Link>
