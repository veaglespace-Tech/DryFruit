      ...
      <div ref={formRef} className="relative w-full max-w-md z-10">
        <div className="bg-white/80 backdrop-blur-md rounded-3xl border border-border-DEFAULT shadow-luxury-xl p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading text-2xl font-bold text-primary-DEFAULT">Welcome back</h1>
            <p className="text-text-muted font-body text-sm mt-1">Savor nature&apos;s premium nutrition</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-border-light text-center space-y-3">
            <p className="text-xs text-text-muted font-body">
              ...
              <Link href="/user/register" className="text-accent-DEFAULT hover:underline font-semibold">
                Register here
              </Link>
            </p>
            <p className="text-xs text-text-muted font-body">
