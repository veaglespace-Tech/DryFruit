...
const MOCK_INQUIRIES = [
  {
    ...
    date: "28 Jun 2026",
    total: 1398,
    items: "Premium California Almonds (500g) x 1, Kashmiri Walnuts (500g) x 1",
    status: "delivered",
  },
  {
    id: "INQ-3920",
    date: "15 May 2026",
    total: 799,
    items: "Whole Cashews W240 (500g) x 1",
    status: "shipped",
  },
  {
    id: "INQ-1829",
    date: "04 Apr 2026",
    total: 1848,
    items: "Iranian Roasted Pistachios (500g) x 1, Medjool Dates (500g) x 1",
    status: "replied",
  },
];
      ...
      <header className="bg-primary-DEFAULT text-white py-4 shadow-luxury relative z-10">
        <div className="container-luxury flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/"
              className="text-xs font-button text-white/80 hover:text-white transition-colors"
            >
              Back to Store
            </Link>
            <button
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="dashboard-card lg:col-span-1 bg-white border border-border-DEFAULT rounded-3xl p-6 shadow-luxury">
            <div className="flex flex-col items-center text-center pb-6 border-b border-border-light mb-6">
              ...
              <h2 className="font-heading text-xl font-bold text-primary-DEFAULT">
                {profile.name}
              </h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 text-sm text-text-muted font-body">
                ...
                <span className="leading-snug">
                  {profile.address || "No shipping address set"}
                </span>
              </div>
            </div>
          ...
          <div className="dashboard-card lg:col-span-2 space-y-6">
            ...
            <div className="bg-white border border-border-DEFAULT rounded-3xl p-6 shadow-luxury min-h-[300px]">
              {activeTab === "orders" && (
                <div>
                  <h3 className="font-heading text-lg font-bold text-primary-DEFAULT mb-4">
                    Inquiry History
                  </h3>
                  <div className="space-y-4">
                    {MOCK_INQUIRIES.map((inq) => (
                      <div
                        key={inq.id}
                        className="p-4 border border-border-light hover:border-border-DEFAULT rounded-2xl flex flex-col md:flex-row justify-between gap-4 transition-all"
                      >
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <span className="font-button font-bold text-sm text-primary-DEFAULT">
                              {inq.id}
                            </span>
                            <span className="text-xxs font-body text-text-muted">
                              {inq.date}
                            </span>
                          </div>
                          <p className="text-xs font-body text-text-muted line-clamp-1">
                            {inq.items}
                          </p>
                        </div>
                        <div className="flex items-center justify-between md:justify-end gap-6">
                          <span className="font-heading text-base font-bold text-primary-DEFAULT">
                            ₹{inq.total}
                          </span>
                          <span
                  ...
                  {!isEditing ? (
                    <div className="space-y-4 font-body text-sm">
                      ...
                      <div className="py-2 text-text-muted flex flex-col gap-1">
                        ...
                        <span className="font-semibold text-primary-DEFAULT mt-1 p-3 bg-background rounded-xl border border-border-light">
