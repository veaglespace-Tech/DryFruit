...
const CATEGORIES = [
  {
    name: "Almonds",
    slug: "almonds",
    desc: "Hand-selected California and Indian almonds, raw and nutrient-dense.",
  ...
  },
  {
    name: "Cashews",
    slug: "cashews",
    desc: "Creamy, large whole cashews from premium Konkan orchards.",
  ...
  },
  {
    name: "Pistachios",
    slug: "pistachios",
    desc: "Vibrant green naturally shelled and perfectly dry-roasted pistachios.",
  ...
  },
  {
    name: "Walnuts",
    slug: "walnuts",
    desc: "Omega-3 brain superfood Kashmiri walnut kernels, raw and wholesome.",
  ...
  },
  {
    name: "Dates",
    slug: "dates",
    desc: "Plump Medjool and Ajwa dates, direct source of natural caramelly energy.",
  ...
  },
  {
    name: "Raisins",
    slug: "raisins",
    desc: "Naturally sun-dried golden and black raisins with a juicy texture.",
  ...
  },
  {
    name: "Mixed Nuts",
    slug: "mixed-nuts",
    desc: "Luxury roasted nut mixes tailored for active snacking profiles.",
  ...
  },
  {
    name: "Dried Berries",
    slug: "dried-berries",
    desc: "Antioxidant powerhouse - dried cranberries, blueberries, and superberries.",
        ...
        <div className="py-10 md:py-12 bg-background border-b border-border-DEFAULT">
          <div className="container-luxury text-center">
            ...
            <p className="body-lead max-w-xl mx-auto mt-4">
              Carefully sorted and packaged categories of premium dry fruits,
